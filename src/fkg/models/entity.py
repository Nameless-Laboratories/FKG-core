...
class Entity(Base):
    ...
    Entities represent nodes such as organizations, services, locations, or people.
    """
    ...
    __table_args__ = (
        Index("ix_entities_type_authority", "type", "authority_id"),
        Index("ix_entities_data_name", "data", postgresql_using="gin"),
    )
    ...
    def to_export_dict(self) -> dict:
        """Convert entity to dictionary for PKG export."""
        return {
            "id": self.id,
            "type": self.type,
            "schema_version": self.schema_version,
